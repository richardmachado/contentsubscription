...
>
  ⚙️
      ...
      <div className="tab-buttons">
        <button className={tab === 'purchased' ? 'active-tab' : ''} onClick={() => setTab('purchased')}>
          Purchased
        </button>
        <button className={tab === 'explore' ? 'active-tab' : ''} onClick={() => setTab('explore')}>
          Explore More
        </button>
      </div>
          ...
          {purchased.length === 0 ? (
            ...
            purchased.map((item) => (
              <div key={item.id} className="content-box">
                ...
                <button className="view-button" onClick={() => alert('Enjoy your content!')}>View</button>
              </div>
            ))
          )}
        </div>
